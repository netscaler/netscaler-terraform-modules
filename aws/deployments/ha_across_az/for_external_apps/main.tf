  ...
  user_data_base64 = base64encode(<<-EOF
    <NS-PRE-BOOT-CONFIG>
      <NS-CONFIG>
        ...
        bind ipset ${var.ipset_name} ${aws_network_interface.client[1].private_ip}

        add lb vserver ${var.lbvserver_name} HTTP ${aws_network_interface.client[0].private_ip} 80 -ipset ${var.ipset_name}
