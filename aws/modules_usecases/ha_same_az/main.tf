...
module "citrixadc_primary" {
  ...
  iam_instance_profile_name   = aws_iam_instance_profile.citrix_adc_ha_instance_profile.name
...
resource "aws_iam_role_policy" "citrix_adc_ha_policy" {
  name = "${local.resource_name_prefix}-citrix_adc_ha_policy"
...
resource "aws_iam_role" "citrix_adc_ha_role" {
  name = "${local.resource_name_prefix}-citrix_adc_ha_role"
  path = "/"
...
resource "aws_iam_instance_profile" "citrix_adc_ha_instance_profile" {
  name = "${local.resource_name_prefix}-citrix_adc_ha_instance_profile"
  path = "/"
  role = aws_iam_role.citrix_adc_ha_role.name
}
